...
namespace test {
      ...
      : Test(window)
    {
        ...
        Ref<Texture2D> diffuseTexture_mirror = std::make_shared<Texture2D>(textureID);
        // shader
        ...
        material_inversion->SetDiffuseTexture(diffuseTexture_mirror);
        material_grayscale->SetDiffuseTexture(diffuseTexture_mirror);
        material_sharpen->SetDiffuseTexture(diffuseTexture_mirror);
        material_blur->SetDiffuseTexture(diffuseTexture_mirror);
        // mesh
